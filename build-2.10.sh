...
./make-distribution.sh -Pyarn -Phive -Phive-thriftserver -Phive-0.13.1 -Phadoop-2.4 -Djava.version=1.7 -Dhadoop.version=2.4.1 -Dyarn.version=2.4.1 -Dzookeeper.version=3.4.5 -DskipTests
